...
public class CharCountSorter {
	...
	// mapper which takes in the output from CharCount and outputs it as val,key
	// so that a secondary sort will occur
	public static class SimpleMapper extends Mapper<Object, Text, IntWritable, Text> {
